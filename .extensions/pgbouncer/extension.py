...
def preprocess_commands(ctx):
    ...
    return (('$HOME/.bp/bin/rewrite',
             '"$HOME/vendor/etc/pgbouncer/pgbouncer.ini"'),)
...
def service_commands(ctx):
    ...
    #  the app.
    return {
        'pgbouncer': ('$HOME/vendor/usr/sbin/pgbouncer',
                      '-v "$HOME/vendor/etc/pgbouncer/pgbouncer.ini"')
    }
...
def load_db_urls():
    ...
    for db in services['elephantsql']:
